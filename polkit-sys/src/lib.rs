...
pub const POLKIT_CHECK_AUTHORIZATION_FLAGS_ALLOW_USER_INTERACTION: PolkitCheckAuthorizationFlags =
    1;
pub const POLKIT_CHECK_AUTHORIZATION_FLAGS_ALWAYS_CHECK: PolkitCheckAuthorizationFlags = 2;
...
unsafe extern "C" {
    ...
    pub fn polkit_unix_process_new_pidfd(
        pidfd: c_int,
        uid: c_int,
        gids: *mut glib::GArray,
    ) -> *mut PolkitSubject;
    pub fn polkit_unix_process_get_gids(process: *mut PolkitUnixProcess) -> *mut glib::GArray;
    ...
    pub fn polkit_unix_process_get_pidfd(process: *mut PolkitUnixProcess) -> c_int;
    pub fn polkit_unix_process_get_pidfd_is_safe(process: *mut PolkitUnixProcess) -> gboolean;
    ...
    pub fn polkit_unix_process_set_gids(process: *mut PolkitUnixProcess, gids: *mut glib::GArray);
    pub fn polkit_unix_process_set_pid(process: *mut PolkitUnixProcess, pid: c_int);
    pub fn polkit_unix_process_set_pidfd(process: *mut PolkitUnixProcess, pidfd: c_int);
