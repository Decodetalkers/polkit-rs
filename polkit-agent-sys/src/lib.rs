...
impl ::std::fmt::Debug for PolkitAgentListenerClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("PolkitAgentListenerClass @ {self:p}"))
...
#[repr(C)]
#[allow(dead_code)]
pub struct _PolkitAgentSessionClass {
    _data: [u8; 0],
    _marker: core::marker::PhantomData<(*mut u8, core::marker::PhantomPinned)>,
}

pub type PolkitAgentSessionClass = _PolkitAgentSessionClass;
...
impl ::std::fmt::Debug for PolkitAgentListener {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("PolkitAgentListener @ {self:p}"))
...
impl ::std::fmt::Debug for PolkitAgentSession {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("PolkitAgentSession @ {self:p}"))
            .finish()
    }
}
...
#[repr(C)]
#[allow(dead_code)]
pub struct PolkitAgentTextListener {
    _data: [u8; 0],
    _marker: core::marker::PhantomData<(*mut u8, core::marker::PhantomPinned)>,
}
...
impl ::std::fmt::Debug for PolkitAgentTextListener {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("PolkitAgentTextListener @ {self:p}"))
            .finish()
    }
}
